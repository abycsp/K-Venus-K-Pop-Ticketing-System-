<?php 
require_once('data/get_kgroup.php');
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">K-Venus Online Ticketing</a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="index.php"><span class="glyphicon glyphicon-backward"></span> logout</a></li>
    </ul>
  </div>
</nav>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">1. CONCERT INFO
...
<div class="container-fluid">
	...
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-body">
			 <h2>
			 	<center>CONCERT INFO</center>
			 </h2>
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-itinerary">
					  <div class="form-group">
					    <label for="">KPOP GROUPS:</label>
					    <select class="btn btn-default" id="orig-id">
					    <?php foreach($kgroups as $o): ?>
					    	<option value="<?= $o['group_id']; ?>"><?= $o['group_desc']; ?></option>
				    	<?php endforeach; ?>
					    </select>
					  </div>
					  <div class="form-group">
...
<script type="text/javascript">
	$(document).on('submit', '#form-itinerary', function(event) {
		...
		/* Act on the event */
		var validate = "";
		var kgroup = $('select[id=orig-id]').val();
